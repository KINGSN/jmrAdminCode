...
public class CloseIdActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_close_id);
        binding = ActivityCloseIdBinding.inflate(getLayoutInflater());
        ...
        preferences = CloseIdActivity.this.getSharedPreferences(GlobalVariables.ADMIN_PREF, MODE_PRIVATE);
...
*/
    ...
    public void getMyId(){
        MyrecyclerView = binding.rvCloseId;
        MyrecyclerView.setLayoutManager(new LinearLayoutManager(CloseIdActivity.this));
        homeTopDepositsDTOArrayList.clear();


        method.loadingDialogg(CloseIdActivity.this);
        //method.loadingDialog.dismiss();

        StringRequest stringRequest = new StringRequest(Request.Method.POST, RestAPI.API_GET_ALLCLOSEID,
                        ...
                        try {
                            ...
                            if (success.equals("1")) {
                                ...
                                for (int i = 0; i < jsonArray2.length(); i++) {
                                    ...
                                    CloseDataAdapter closeDataAdapter= new CloseDataAdapter(homeTopDepositsDTOArrayList,CloseIdActivity.this);
                                    MyrecyclerView.setAdapter(closeDataAdapter);
                                ...
                                method.loadingDialog.dismiss();
                                Method.alertBox("2",jsonObject1.getString("title"),jsonObject1.getString("msg"), CloseIdActivity.this,GlobalVariables.btntxt);
        ...
        RequestQueue requestQueue= Volley.newRequestQueue(CloseIdActivity.this);
