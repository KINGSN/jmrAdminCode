...
import com.gpuntd.adminapp.databinding.ItemClosedIdRequestBinding;
...
public class CloseDataAdapter extends RecyclerView.Adapter<CloseDataAdapter.MyViewHolder> {
    ...
    ItemClosedIdRequestBinding binding;
    ...
    public CloseDataAdapter(List<HomeTopDepositsDTO> topDepositsDTOS, Context context) {
        this.topDepositsDTOS = (ArrayList<HomeTopDepositsDTO>) topDepositsDTOS;
        CloseDataAdapter.context = context;
    }
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        binding = DataBindingUtil.inflate(layoutInflater, R.layout.item_closed_id_request, parent, false);
        method=new Method(parent.getContext());
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
      ...
      /*  holder.binding.btnDeletePassRequest.setOnClickListener(new View.OnClickListener() {
        ...
        switch (topDepositsDTO.getTxnStatus()) {
            ...
            holder.binding.btnApproveCloseIdReq.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    ...
                    //CloseDataAdapter.setupUpdateDialog(v);
                    AStatus="1";
                    updateonClick();
                }
            });
        ...
        holder.binding.btnCancelCloseIdReq.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Log.d(TAG, "onClick: "+topDepositsDTOS.get(position).getPayMentMode()+"\n"+topDepositsDTOS.get(position).getName());
                myIdData=topDepositsDTOS.get(position);
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(ItemClosedIdRequestBinding binding) {
    ...
    public static void setupUpdateDialog(View v){
        ...
        if(myIdData.getTxnStatus().equals("0")){
            ...
            sw.setChecked(false);
            AStatus="2";
        }else if(myIdData.getTxnStatus().equals("0")){
            etEditDatePassReq.setText(myIdData.getTxnDate());
            sw.getTextOff();
            sw.setSelected(false);
            sw.setChecked(false);
    ...
    private static void updateonClick() {
        if (method.adminDTO.getManageCloseID().equals("2")) {
            method.params.clear();
            method.params.put("CloseIDUpdate", "CloseIDUpdate");
