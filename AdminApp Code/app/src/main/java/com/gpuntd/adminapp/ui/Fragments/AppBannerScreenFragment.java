 ...
 */
public class AppBannerScreenFragment extends Fragment {
    ...
    public AppBannerScreenFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.fragment_bannerscreen, container, false);
