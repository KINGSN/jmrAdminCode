 ...
 */
public class AppOnesigScreenFragment extends Fragment {
    ...
    public AppOnesigScreenFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.fragment_onesignal, container, false);
