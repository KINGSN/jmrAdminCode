...
public class UserAllWithdrawFragment extends Fragment {
                            ...
                            if (success.equals("1")) {
                                ...
                                if(jsonArray2.length() !=0) {
                                    for (int i = 0; i < jsonArray2.length(); i++) {
                                        ...
                                        WitdrawalsDataAdapter witdrawalsDataAdapter = new WitdrawalsDataAdapter(homeTopDepositsDTOArrayList, requireActivity());
                                ...
                                //Method.alertBox("2",jsonObject1.getString("title"),jsonObject1.getString("msg"), requireActivity(),GlobalVariables.btntxt);
                                binding.rvCreateID.setVisibility(View.GONE);
                                binding.animationView.setVisibility(View.VISIBLE);
                                method.loadingDialog.dismiss();
                                binding.animationView.playAnimation();
