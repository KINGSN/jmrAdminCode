...
import com.gpuntd.adminapp.adapter.CloseDataAdapter;
import com.gpuntd.adminapp.adapter.WitdrawalsDataAdapter;
import com.gpuntd.adminapp.databinding.ActivityCloseIdBinding;
import com.gpuntd.adminapp.databinding.ActivityWithdrawRequestBinding;
...
public class WithdrawRequestActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar = findViewById(R.id.toolbarWith);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);


        preferences = WithdrawRequestActivity.this.getSharedPreferences(GlobalVariables.ADMIN_PREF, MODE_PRIVATE);
...
*/
    ...
    public void getMyId(){
        MyrecyclerView = binding.rvWithdrawReq;
        MyrecyclerView.setLayoutManager(new LinearLayoutManager(WithdrawRequestActivity.this));
        homeTopDepositsDTOArrayList.clear();


        method.loadingDialogg(WithdrawRequestActivity.this);
        //method.loadingDialog.dismiss();

        StringRequest stringRequest = new StringRequest(Request.Method.POST, RestAPI.API_GET_ALLWITHDRAWALS,
                        ...
                        try {
                            ...
                            if (success.equals("1")) {
                                ...
                                for (int i = 0; i < jsonArray2.length(); i++) {
                                    ...
                                    WitdrawalsDataAdapter witdrawalsDataAdapter= new WitdrawalsDataAdapter(homeTopDepositsDTOArrayList,WithdrawRequestActivity.this);
                                    MyrecyclerView.setAdapter(witdrawalsDataAdapter);
                                ...
                                method.loadingDialog.dismiss();
                                Method.alertBox("2",jsonObject1.getString("title"),jsonObject1.getString("msg"), WithdrawRequestActivity.this,GlobalVariables.btntxt);
